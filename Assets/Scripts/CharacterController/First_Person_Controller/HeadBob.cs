...
namespace VHS
{
    public class HeadBob
    {
        ...
        public bool ScrollHeadBob(bool _running, bool _crouching, Vector2 _input)
        {
            m_resetted = false;
            ...
            int m_yScrollTemp = Mathf.FloorToInt(m_yScroll/2);
            ...
            return Mathf.FloorToInt(m_yScroll/2) > m_yScrollTemp;
        }
